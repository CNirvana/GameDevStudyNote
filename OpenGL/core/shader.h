...
public:
	...
	void loadFromSource(const char* vSource, const char* fSource, const char* gSource = nullptr);

	void bind() const { GL_CALL(glUseProgram(m_ID)); }
	void unbind() const { GL_CALL(glUseProgram(0)); }
